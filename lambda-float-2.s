...
.LFB1486:
	...
	.p2align 5
.L25:
	vcvtsi2ss	%ebx, %xmm15, %xmm15
	vmovss	%xmm1, (%rsp)
	vmulss	_ZL3src(,%rbx,4), %xmm15, %xmm0
	call	sqrtf
	leaq	1(%rbx), %r9
	vmovss	(%rsp), %xmm14
	vaddss	%xmm0, %xmm14, %xmm13
	vcvtsi2ss	%r9d, %xmm12, %xmm12
	vmovss	%xmm13, 44(%rsp)
	vmulss	_ZL3src(,%r9,4), %xmm12, %xmm0
	call	sqrtf
	leaq	2(%rbx), %r8
	vaddss	44(%rsp), %xmm0, %xmm11
	vcvtsi2ss	%r8d, %xmm10, %xmm10
	vmovss	%xmm11, 44(%rsp)
	vmulss	_ZL3src(,%r8,4), %xmm10, %xmm0
	call	sqrtf
	leaq	3(%rbx), %rdi
	vaddss	44(%rsp), %xmm0, %xmm9
	vcvtsi2ss	%edi, %xmm8, %xmm8
	vmovss	%xmm9, 44(%rsp)
	vmulss	_ZL3src(,%rdi,4), %xmm8, %xmm0
	call	sqrtf
	leaq	4(%rbx), %rsi
	vaddss	44(%rsp), %xmm0, %xmm7
	vcvtsi2ss	%esi, %xmm6, %xmm6
	vmovss	%xmm7, 44(%rsp)
	vmulss	_ZL3src(,%rsi,4), %xmm6, %xmm0
	call	sqrtf
	leaq	5(%rbx), %rcx
	vaddss	44(%rsp), %xmm0, %xmm5
	vcvtsi2ss	%ecx, %xmm4, %xmm4
	vmovss	%xmm5, 44(%rsp)
	vmulss	_ZL3src(,%rcx,4), %xmm4, %xmm0
	call	sqrtf
	leaq	6(%rbx), %rdx
	vaddss	44(%rsp), %xmm0, %xmm3
	vcvtsi2ss	%edx, %xmm2, %xmm2
	vmovss	%xmm3, 44(%rsp)
	vmulss	_ZL3src(,%rdx,4), %xmm2, %xmm0
	call	sqrtf
	leaq	7(%rbx), %rax
	vaddss	44(%rsp), %xmm0, %xmm1
	vcvtsi2ss	%eax, %xmm0, %xmm0
	vmovss	%xmm1, 44(%rsp)
	vmulss	_ZL3src(,%rax,4), %xmm0, %xmm0
	addq	$8, %rbx
	call	sqrtf
	cmpq	$10000, %rbx
	vaddss	44(%rsp), %xmm0, %xmm1
...
.LLSDACSB1506:
	.uleb128 .LEHB4-.LFB1506
	.uleb128 .LEHE4-.LEHB4
	.uleb128 .L127-.LFB1506
	.uleb128 0
	.uleb128 .LEHB5-.LFB1506
	.uleb128 .LEHE5-.LEHB5
	.uleb128 .L126-.LFB1506
	.uleb128 0
	.uleb128 .LEHB6-.LFB1506
	.uleb128 .LEHE6-.LEHB6
	.uleb128 0
	.uleb128 0
	.uleb128 .LEHB7-.LFB1506
	.uleb128 .LEHE7-.LEHB7
	.uleb128 0
	.uleb128 0
.LLSDACSE1506:
...
.LLSDACSB1513:
	...
	.uleb128 .LEHE8-.LEHB8
	.uleb128 .L159-.LFB1513
	.uleb128 0
	.uleb128 .LEHB9-.LFB1513
	.uleb128 .LEHE9-.LEHB9
	.uleb128 .L158-.LFB1513
	.uleb128 0
	.uleb128 .LEHB10-.LFB1513
	.uleb128 .LEHE10-.LEHB10
	.uleb128 0
	.uleb128 0
	.uleb128 .LEHB11-.LFB1513
